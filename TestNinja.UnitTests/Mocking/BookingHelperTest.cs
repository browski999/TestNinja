...
{
    [TestFixture]
    public class BookingHelper_OverlappingBookingsExists
    {
        ...
        public void SetUp()
        {
            ...
            {
                Id = 2,
                ArrivalDate = ArriveOn(2017, 1, 22),
                DepartureDate = DepartOn(2017, 1, 29),
                Reference = "a"
            };
        ...
        [Test]
        public void BookingStartsBeforeAndFinishesInMiddleOfAnExistingBooking_ReturnExistingBooking()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingsOverlapButNewVBookingIsCancelled_ReturnEmptyString()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
